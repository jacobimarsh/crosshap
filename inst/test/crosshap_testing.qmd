...
pre_anim_gg <- crosshap::prepare_hap_umap(umap_in, HapObject = Haplotypes_MGmin30_E0.6, vcf = vcf, nsamples = 25)

hap_gganim <- pre_anim_gg +
  ggplot2::facet_wrap(~hap, ncol = 2) +
...
gganimate::anim_save("hap_anim_cols.gif", hap_gganim)
```
